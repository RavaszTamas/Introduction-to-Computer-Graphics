...
namespace Modules
{
  public class AllRGBModule : DefaultRasterModule
  {
    /// <summary>
    ...
    /// </summary>
    public override string Name => "All RGB";

    /// <summary>
    /// Tooltip for Param (text parameters).
    /// </summary>
    public override string Tooltip => "{separate} [alt]";
    ...
    protected void recompute ()
    {
          ...
          inImage != null)
      {
        ...
        if (dirty)
        {
          ImageHistogram.ComputeHistogramAll(inImage,param);
          dirty = false;
        }
        ImageHistogram.DrawHistogramAll(hImage);
    ...
    /// Usage: nxm (n,m elem of N, n X coordiante, m Y coordiante)
    /// </summary>
